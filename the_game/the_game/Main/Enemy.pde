public class Enemy extends Animate{
    ...
    public Enemy(PImage img, float scale, float bLeft, float bRight){
        ...
        // moveLeft[0] = loadImage("../Zombie/zombie_walkl0.png");
        // moveLeft[1] = loadImage("../Zombie/zombie_walkl1.png");
        // moveLeft[2] = loadImage("../Zombie/zombie_walkl2.png");
        // moveLeft[3] = loadImage("../Zombie/zombie_walkl3.png");
        // moveLeft[4] = loadImage("../Zombie/zombie_walkl4.png");
        // moveLeft[5] = loadImage("../Zombie/zombie_walkl5.png");
        // moveLeft[6] = loadImage("../Zombie/zombie_walkl6.png");
        // moveLeft[7] = loadImage("../Zombie/zombie_walkl7.png");
        ...
        // moveRight[0] = loadImage("../Zombie/zombie_walkr0.png");
        // moveRight[1] = loadImage("../Zombie/zombie_walkr1.png");
        // moveRight[2] = loadImage("../Zombie/zombie_walkr2.png");
        // moveRight[3] = loadImage("../Zombie/zombie_walkr3.png");
        // moveRight[4] = loadImage("../Zombie/zombie_walkr4.png");
        // moveRight[5] = loadImage("../Zombie/zombie_walkr5.png");
        // moveRight[6] = loadImage("../Zombie/zombie_walkr6.png");
        // moveRight[7] = loadImage("../Zombie/zombie_walkr7.png");
